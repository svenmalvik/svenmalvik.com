...
![Event flow diagram of how Azure App Configuration events trigger Azure API Management deployments](https://cdn.svenmalvik.com/images/apim-aks-blue-green.png)*Event flow diagram of how Azure App Configuration events trigger Azure API Management deployments*{: style="float: right"}
