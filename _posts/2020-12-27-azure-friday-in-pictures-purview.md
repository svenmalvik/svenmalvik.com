...
*[[Source]](https://azure.microsoft.com/en-us/resources/videos/azure-friday-enable-unified-data-governance-with-azure-purview/?WT.mc_id=AZ-MVP-5004080) Azure Purview is a unified data governance service that helps you manage and govern your on-premises, multi-cloud, and software-as-a-service (SaaS) data. Gaurav Malhotra joins Scott Hanselman to show how easy it is to create a holistic, up-to-date map of your data landscape with automated data discovery, sensitive data classification, and end-to-end data lineage so that you can empower your data consumers to find valuable, trustworthy data.*
