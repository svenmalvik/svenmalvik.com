...
async function createFavicons() {
  ...
  // PNG icons
  await sharp(svgBuffer).resize(192, 192).toFile(
    `${outputDir}/icon-192x192.png`,
  );
  await sharp(svgBuffer).resize(512, 512).toFile(
    `${outputDir}/icon-512x512.png`,
  );
  await sharp(svgBuffer).resize(180, 180).toFile(
