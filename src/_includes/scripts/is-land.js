(() => {
  ...
  var p = (h, t, e) =>
    t in h
      ? m(h, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : h[t] = e;
  var l = (h, t, e) => p(h, typeof t != "symbol" ? t + "" : t, e);
  var r = class r extends HTMLElement {
    ...
    async hydrate() {
      ...
      this.readyResolve(),
        ...
        this.querySelectorAll(`[${r.attr.defer}]`).forEach((a) =>
          a.removeAttribute(r.attr.defer)
        );
    }
  };
  l(r, "tagName", "is-land"),
    ...
    l(r, "fallback", {
      ":not(is-land,:defined,[defer-hydration])": (t, e, a) => {
        ...
        if (!o) {
          ...
          if (n) {
            let f = n.getAttribute("shadowrootmode") ||
              n.getAttribute("shadowroot") || "closed";
            o = e.attachShadow({ mode: f }),
              o.appendChild(n.content.cloneNode(!0));
          }
        }
        return o && i.attachShadow({ mode: o.mode }).append(...o.childNodes),
  ...
  var d = r,
    s = class s {
      ...
      static interaction(t, e) {
        ...
        return t && (a = (t || "").split(",").map((i) => i.trim())),
          new Promise((i) => {
            function o(n) {
              i();
      ...
      static media(t) {
        let e = { matches: !0 };
        if (
          t && "matchMedia" in window && (e = window.matchMedia(t)), !e.matches
        ) {
          return new Promise((a) => {
            e.addListener((i) => {
              i.matches && a();
      ...
      static saveData(t) {
        if (
          !(!("connection" in navigator) ||
            navigator.connection.saveData === (t !== "false"))
        ) return new Promise(() => {});
      }
    };
  l(s, "map", {
  ...
  "customElements" in window &&
    (window.customElements.define(d.tagName, d), window.Island = d);
  var w = d.ready;
})();
